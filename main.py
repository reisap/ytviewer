...
class Program(object):
	...
	def run():
		...
		Program.processes=[Process(target=Bot.run,args=(urls,Program.browser,proxies,referers,user_agents,args.duration,executable_path,extension_path),daemon=True) for _ in range(args.processes)]
